...
def html_walk(res,co2,mood,fuel):
    ...
    return f"""<!DOCTYPE html>
           ...
           <body style="margin:50px;text-align:center; background:#cff6fd; 
                ...
                <table style="margin: 0 auto;" cellspacing="100">
                    <tr>
                        <td WIDTH="20" HEIGHT="20">
                            <h1>You save:{co2} g of CO2 and {round(fuel,2)}€<h1>
                        </td>
                        <td>
            ...
            <table style="margin: 0 auto;" cellspacing="40">
                ...
                <tr>
                    <td>
                        <img width="400" height="300" src="{avurl[0]}" alt="travel">
                    </td>
                    <td>
                        <img width="400" height="300" src="{avurl[1]}" alt="travel">
                    </td>
                    <td>
                        <img width="400" height="300" src="{avurl[2]}" alt="travel">
                    </td>
                </tr>
                <tr>
                    <td>
...
def html_driving(res,co2,mood,fuel):
    aviones=pd.read_csv("./aviones.csv")
    travel=aviones[aviones["Estilo"]==mood]
    travel=travel.sample(3)
    avco2=[i for i in travel["CO2/pass"]]
           ...
           <body style="margin:50px;text-align:center; background:#cff6fd; 
            ...
            <div style="text-align:center;">
                <table style="margin: 0 auto;" cellspacing="100">
                    <tr>
                        <td WIDTH="20" HEIGHT="20">
                            <h1>ARE YOU SURE???:puf! {co2}g of CO2 to the planet!</h1>
                        </td>
                        <td>
                            <h1>{res._repr_html_()}<h1>
                        </td>
...
def html_bike(res,co2,mood,fuel):
    aviones=pd.read_csv("./aviones.csv")
    travel=aviones[aviones["Estilo"]==mood]
    travel=travel.sample(3)
    avco2=[i for i in travel["CO2/pass"]]
           ...
           <body style="margin:50px;text-align:center; background:#cff6fd; 
            ...
            <div style="text-align:center;">
                <table style="margin: 0 auto;" cellspacing="100">
                    <tr>
                        <td WIDTH="20" HEIGHT="20">>
                            <h1 >You save:{co2} g of CO2 and {round(fuel-0.5,2)}€<h1>
                        </td>
                        <td>
                            <h1>{res._repr_html_()}<h1>
                        </td>
